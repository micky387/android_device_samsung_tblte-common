...
BOARD_KERNEL_CMDLINE := console=null androidboot.hardware=qcom user_debug=23 msm_rtb.filter=0x3b7 dwc3_msm.cpu_to_affin=1 androidboot.bootdevice=msm_sdcc.1 zcache.enabled=1 zcache.compressor=lz4
